...
2.2 Create key in kms (AWS): 
choice Symmetric A single encryption key that is used for both encrypt and decrypt operations
click next, enter Alias (name your key)
...
Prometheus monitoring for vault
